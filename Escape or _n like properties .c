...
int main (){
    ...
    int c = 56;
    int d = 76;
    // escape sequence menas \n wali chize
    //printf("%d\a", a); // alarm ⏰
    printf(" %d\b ", b); // backspace means last one character word mai se hta deta hai 
    printf(" %d\n ", c); // new line
    printf(" %d\\ ", d); // backslast means backslash \ ye lga deta hai last mai 
    printf(" %d\' ", d); // last mai single quote lga dega 76'
    printf(" %d\" ", c); // last mai double quote lga deta hai 56"
    printf(" %d\t ", a); // 4 space chod ke deta hai  admi	aurat
...
/*
// natural number 1 to 50 using recursion 
#include<stdio.h>
 void main (){
 	print(1);
 }
