// storage class question 7
// try to solve on copy 
#include<stdio.h>

main(){
	register int data = 10; // this give error 
//  int data = 10; // this give 5 
    // if we use register storage class then variable is store in cpu register 
    // if variable is tsore in cpu register then it don't point to a memory location so these variable don't have address
    // so we don't have addres so how we use pointer 
    // so this program give error 
    // if we use simple int variable then it store in memory and we can use pointer to store variables address 
    int *pisumdata = NULL;
    pisumdata = &data;
    *pisumdata = 5;
    printf("%d", *pisumdata);
...
// storage class question 6
// try to solve on copy 
#include<stdio.h>
int i = 5;
int main(){
	extern int j; // extern int j find j from from out of the main block 
    // if j is fldefine in main block it don't take the value and  give error
    printf("i = %d j = %d",i,j);
...
// int main block int j = 10 is already defined
// and we also declare int j = 55 so extern j is confused and then it give error 
...
// storage class question 5
// try to solve on copy 
#include<stdio.h>
int main(){
	extern int i; //it find i value from out of the main block 
   // if value of i is not present out of main then it give error
   // but if value of a is define from out of main block then it don't give error 
    printf("i = %d\n", i);
    {
    	int i = 34;
        printf("i = %d", i);
...
//int i = 25; // if I don't write int i = 25 then it give error 
// linker error
...
void prtfun(void){
	register int a = 2; // it is gain intialized with 2 it don't retins it's previous value 
    int b = 1; 
    a += ++b; 
  //  a = a + ++b;
    printf("a = %d b = %d\n", a,b);
...
void prtfun(void){
	static int a = 2; // a retians it's previous value in second iteration 
    int b = 1; // but b is again initialized with 1 
    a += ++b; 
  //  a = a + ++b;
    printf("a = %d b = %d\n", a,b);
}
