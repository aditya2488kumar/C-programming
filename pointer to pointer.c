...
int main(){
    ...
    int * ptr;
    ptr = &a;// pointer
    int **pptr;// pointer to Pinter to variable 
    pptr = &ptr;
    int ***ak;// Pinter to Pinter to Pinter to variable 
    ak = &pptr;
    ***ak = 15;
    printf("a = %d %d %d %d ", a, *ptr, **pptr, ***ak );  
...
int main(){
    ...
    *q = *p;
    ...
    printf("value a is %d %d an q is %d ", a, *p, *q); 
...
printf("jo addrres stroe hai uski value %d\n", *ptr);

// %d  and %u give integers value 
// %x give hexadecimal value eg  57gnk6dj9hh 
